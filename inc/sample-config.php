<?php
    ...
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Настроики', 'redux-framework-demo' ),
        'id'               => 'basic',
   ...
   Redux::setSection( $opt_name, array(
       ...
       'fields'     => array(
           array(
               'id'          => 'opt-slides',
               'type'        => 'slides',
               'title'       => __( 'Настроики слайдера', 'redux-framework-demo' ),
               'subtitle'    => __( 'Рекомендуемый размер 1600х800 или 1000х500. Желательно чтобы была пропорция 2х1', 'redux-framework-demo' ),
               'desc'        => __( 'Это список всех слайдов' ),
               'placeholder' => array(
